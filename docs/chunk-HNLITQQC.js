import{Ba as i,M as n}from"./chunk-XCU44MAK.js";var l=[{name:"Daily coding problems",questions:[{id:"1",statement:`This problem was recently asked by Google.

Given a list of numbers and a number k, return whether any two numbers from the list add up to k.
For example, given [10, 15, 3, 7] and k of 17, return true since 10 + 7 is 17.

Bonus: Can you do this in one pass?`,solution:`{
    const arr = [10, 15, 3, 7];
    const k = 17;
    let result = false;
    ...
    console.log(result);
}`},{id:"2",statement:`This problem was asked by Uber.

Given an array of integers, return a new array such that each element at index i of the new array is the product of all the numbers in the original array except the one at i.
For example, if our input was [1, 2, 3, 4, 5], the expected output would be [120, 60, 40, 30, 24]. If our input was [3, 2, 1], the expected output would be [2, 3, 6].

Follow-up: what if you can't use division?`,solution:`{
    const arr = [1, 2, 3, 4, 5];
    const result = [];
    let left = 1;
    ...
    console.log(result);
}`},{id:"3",statement:`This problem was asked by Stripe.

Given an array of integers, find the first missing positive integer in linear time and constant space. In other words, find the lowest positive integer that does not exist in the array. The array can contain duplicates and negative numbers as well.
For example, the input [3, 4, -1, 1] should give 2. The input [1, 2, 0] should give 3.
You can modify the input array in-place.`,solution:`{
...
}`},{id:"4",statement:`This problem was asked by Jane Street.
...
def cons(a, b):
    def pair(f):
        return f(a, b)
    return pair
Implement car and cdr.`,solution:`{
...
}`},{id:"5",statement:`This problem was asked by Facebook.

Given the mapping a = 1, b = 2, ... z = 26, and an encoded message, count the number of ways it can be decoded.
For example, the message '111' would give 3, since it could be decoded as 'aaa', 'ka', and 'ak'.
You can assume that the messages are decodable. For example, '001' is not allowed.`,solution:`{
...
}`}]},{name:"Linked list",questions:[{id:"Push",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
    }
...
Increase the length attribute by one.`,solution:`push(value) {
    const newNode = new Node(value);
    if (!this.head) {
        this.head = newNode;
        this.tail = this.head;
...
Return the removed node`,solution:`pop() {
...
Increase the length attribute by one.`,solution:`unshift(value) {
    const newNode = new Node(value);
    if (!this.head) {
        this.head = newNode;
        this.tail = newNode;
...
Return the removed node.`,solution:`shift() {
    if (!this.head) {
        return this.head
    }
...
Return the node at which temp is pointing after the loop ends.`,solution:`get(index) {
...
Return true if the value has been successfully set.`,solution:`set(index, value) {
...
Return true to indicate the node was successfully inserted.`,solution:`insert(index, value) {
    if (index === 0) {
...
Return the removed node.`,solution:`remove(index) {
    if (index === 0) {
            return this.shift();
        }
...
After you have iterated through all the nodes and reversed their next pointers, your reverse method is done.`,solution:`reverse() {
    let temp = this.head;
    this.head = this.tail;
    this.tail = temp;
    let next;
    ...
    return this;
}`},{id:"Find Middle Node",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
    }
...
After calling the findMiddleNode() function:
let middle = list.findMiddleNode();
The middle node should have the value 4.`,solution:`findMiddleNode(){
...
`,solution:`hasLoop(){
    ...
    return false;
}`},{id:"Find Kth Node From End",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
    }
...
The kthNode should have the value 3.`,solution:`findKthFromEnd(k){
    ...
    return pointer1;
}`},{id:"Partition List",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
    }
...
`,solution:`partitionList(x){
    ...
    return this;
}`},{id:"Remove Duplicates",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
    }
...
Remember to update the length.`,solution:`removeDuplicates(){
...
}`},{id:"Binary to Decimal",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
    }
...
Return the value in num, which now represents the decimal value of the binary number in the linked list.`,solution:`binaryToDecimal(){
    ...
    return num;
}`},{id:"Reverse Between",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
    }
...
The linked list should now have the following values:
1 -> 2 -> 3 -> 6 -> 5 -> 4`,solution:`reverseBetween(m,n){
...
}`}]},{name:"Doubly linked list",questions:[{id:"Push",shell:`class Node {
    constructor(value){
        this.value = value;
        this.next = null;
        this.prev = null;
...
Return the list (this step is optional).`,solution:`push(value) {
    const newNode = new Node(value);
    if (!this.head) {
        this.head = newNode;
        this.tail = newNode;
...
Return the value of the removed node.`,solution:`pop() {
    if (!this.head)
        return undefined;
    ...
    this.length--;
    return removed;
}`}]}];var u=(()=>{class e{get question(){try{return JSON.parse(localStorage.getItem("currentQuestion")??"null")}catch(t){return console.log(t),null}}currentQuestion=i(this.question??l[0].questions[0]);static \u0275fac=function(s){return new(s||e)};static \u0275prov=n({token:e,factory:e.\u0275fac,providedIn:"root"})}return e})();export{l as a,u as b};
